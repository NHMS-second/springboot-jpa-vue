...
public enum ExceptionCode {
    ...
    DAILY_RECHARGE_LIMIT(40114, "每人每天只能充值一次！"),

    NOT_FIRST_BUY(40013, "你不是首次充值用户！"),
    ...
    //设备key 57*****
    qnique_id_exist(57001,"设备唯一ID重复"),
    device_key_exist(57002,"设备key重复"),
    excel_qnique_id_error(57003,"EXCEL表中设备唯一ID格式不对"),
    excel_device_key_error(57004,"EXCEL表中设备key格式不对"),
...
//    NO_PERMISSION_DELIVERED(60004, "此工单不属于你配送"),
    ...
    MACHINE_IS_USING(75002, "该机器已被占用"),
